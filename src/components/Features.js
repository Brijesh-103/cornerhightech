...
import { Cpu, Globe, Trophy, Zap, Shield, Brain } from "lucide-react"
  ...
  const features = [
    {
      ...
      description:
        "Molecular-level precision with quantum-enhanced manufacturing processes achieving tolerances of ±0.0001mm.",
    ...
    },
    {
      ...
      description:
        "Neural networks continuously optimize cutting patterns and tool performance for maximum efficiency.",
    ...
    },
    {
      ...
      description:
        "Certified by the Intergalactic Precision Council and trusted by master artisans across the universe.",
  ...
  return (
    <section ref={sectionRef} className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        ></div>
        <div
          className="absolute top-3/4 left-1/2 w-32 h-32 bg-yellow-500/10 rounded-full blur-2xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
            We've transcended traditional manufacturing to create tools that exist at the intersection of quantum
            physics, artificial intelligence, and master craftsmanship.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-r ${feature.gradient} p-[1px]`}
              >
        ...
        <div ref={ctaRef} className="relative glass-morphism rounded-3xl p-12 text-center overflow-hidden">
          {/* Background effects */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              {
                "Join the elite circle of quantum artisans who have unlocked the secrets of perfect precision. Your masterpieces await their quantum evolution."
              }{" "}
              {/* Fixed unescaped apostrophe by wrapping in curly braces */}
            </p>
