  ...
  const testimonials = [
    {
      ...
      content:
        "These quantum tools have revolutionized my workshop. The precision is beyond anything I've experienced in 20 years of crafting. The AI assistance feels like having a master craftsman guiding every cut.",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "The holographic interface and quantum precision have elevated my designs to levels I never thought possible. My clients are amazed by the intricate details achievable with these tools.",
      rating: 5,
    ...
    },
    {
      ...
      content:
        "As a solo artisan, having AI-powered tools that adapt to my style and provide real-time feedback has been game-changing. The self-healing materials mean I never worry about tool maintenance.",
      rating: 5,
  ...
  return (
    <section ref={sectionRef} className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-cyan-500/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
            Discover how master artisans across the galaxy have transcended traditional crafting with our
            quantum-enhanced precision tools.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-r ${testimonial.gradient} p-[1px]`}
              >
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="inline-flex items-center space-x-1 px-2 py-1 glass-morphism rounded-full">
                      ...
                      <span className="text-xs text-cyan-400 font-semibold">{testimonial.achievement}</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          {[
            ...
            <div
              key={index}
              className="text-center glass-morphism rounded-xl p-6 hover:scale-105 transition-transform duration-300"
            >
              <div className={`text-3xl font-bold ${stat.color} mb-2 glow-text`}>{stat.number}</div>
