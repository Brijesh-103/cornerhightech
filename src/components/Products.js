...
import { Star, Eye, ShoppingCart, Zap, Award } from "lucide-react"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            {
              "Discover our revolutionary collection of quantum-enhanced tools that push the boundaries of precision engineering and redefine what's possible in jewelry crafting."
            }
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {products.map((product, index) => (
            ...
            >
              {/* Badge */}
              <div
                className={`absolute top-4 left-4 z-10 px-3 py-1 rounded-full text-xs font-bold text-white ${getBadgeColor(product.badge)}`}
              >
                {product.badge}
              </div>
